...
class GenerationMixin:
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        model_kwargs["ent_ids"] = ent_ids
        model_kwargs["rel_ids"] = rel_ids
        model_kwargs["vocab_embed"] = self.shared.weight.data
    ...
    def beam_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            model_inputs['mode'] = model_kwargs['mode']
            model_inputs['ent_ids'] = model_kwargs['ent_ids']
            model_inputs['rel_ids'] = model_kwargs['rel_ids']
            outputs = self(
                **model_inputs,
                return_dict=True,
                output_attentions=output_attentions,
            ...
            next_token_scores = next_token_scores_processed + beam_scores[:, None].expand_as(next_token_scores) + 2 * outputs.structural_vocab_probs
            if return_dict_in_generate:
                if output_scores:
